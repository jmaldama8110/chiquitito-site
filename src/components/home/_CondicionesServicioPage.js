...
const CondicionesServicioPage = () => {
    ...
    <div>
        ...
        <div className='contenido-centrado'>
            ...
            <p>
            CHIQUITITODETALLES Política de Términos y Condiciones
            Bienvenido a CHIQUITITODETALLES. Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web CHIQUITITODETALLES.
            
            CHIQUITITODETALLES se encuentra en 2a norte Oriente 1804, Barrio la Pimienta, Tuxtla Gutierrez, Chiapas, México.
            
            Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones en su totalidad. No continúes usando el sitio web CHIQUITITODETALLES si no aceptas todos los términos y condiciones establecidos en esta página.
            ...
            Empleamos el uso de cookies. Al utilizar el sitio web de CHIQUITITODETALLES, usted acepta el uso de cookies de acuerdo con la política de privacidad de CHIQUITITODETALLES. La mayoría de los modernos sitios web interactivos de hoy en día usan cookies para permitirnos recuperar los detalles del usuario para cada visita.
            ...
            A menos que se indique lo contrario, CHIQUITITODETALLES y/o sus licenciatarios les pertenecen los derechos de propiedad intelectual de todo el material en CHIQUITITODETALLES.
            
            Todos los derechos de propiedad intelectual están reservados. Puedes ver y/o imprimir páginas desde https://www.chiquititodetalles.com/ para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.
            
            No debes:
            
            Volver a publicar material desde https://www.chiquititodetalles.com/
            Vender, alquilar u otorgar una sub-licencia de material desde https://www.chiquititodetalles.com/.
            Reproducir, duplicar o copiar material desde https://www.chiquititodetalles.com/.
            Redistribuir contenido de CHIQUITITODETALLES, a menos de que el contenido se haga específicamente para la redistribución.
            Aviso legal
...
export { CondicionesServicioPage as default };